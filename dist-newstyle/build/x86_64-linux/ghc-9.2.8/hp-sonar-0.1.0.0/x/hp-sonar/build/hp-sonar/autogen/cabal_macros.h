...
/* package hp-sonar-0.1.0.0 */
#ifndef VERSION_hp_sonar
#define VERSION_hp_sonar "0.1.0.0"
#endif /* VERSION_hp_sonar */
#ifndef MIN_VERSION_hp_sonar
#define MIN_VERSION_hp_sonar(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hp_sonar */
/* package Chart-1.9.5 */
...
#define CURRENT_COMPONENT_ID "hp-sonar-0.1.0.0-inplace-hp-sonar"
